            ...
            <div class="carousel-item item-bg">
                ...
                <div class="carousel-caption banner-slider-inner d-flex h-100 text-center">
                    <div class="carousel-content container b1-inner-2">
                        <div class="t-right">
                            <h5 data-animation="animated fadeInDown delay-05s">The Best Real Estate Deals</h5>
                            <h1 data-animation="animated fadeInDown delay-05s">Best Place For Sell Projects</h1>
                            <a data-animation="animated fadeInUp delay-10s" href="#" class="btn btn-lg btn-theme">More Details</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="property-box-7">
                        <div class="property-thumbnail">
                            <a href="properties-details.html" class="property-img">
                                ...
                                <img src="http://placehold.it/350x233" alt="property-box-7" class="img-fluid">
                            </a>
                        </div>
                        <div class="detail">
                            <h1 class="title">
                ...
                <div class="property-box-2">
                    <div class="property-thumbnail">
                        <a href="properties-details.html" class="property-img">
                            ...
                            <img src="http://placehold.it/255x327" alt="property-2" class="img-fluid">
                            <div class="info">
                                <ul class="facilities-list clearfix">
                                    <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-12 cp-2">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-pad wow fadeInLeft delay-04s">
                            <div class="overview overview-box">
                                <img src="http://placehold.it/631x354" alt="popular-places">
                                <div class="mask">
                        ...
                        <div class="col-md-6 col-sm-12 col-pad wow fadeInUp delay-04s">
                            <div class="overview overview-box">
                                <img src="http://placehold.it/307x354" alt="popular-places">
                                <div class="mask">
                                    <div class="info">
                                        <div class="ds">
                                            <h2>Rome</h2>
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 col-pad cp-3 wow fadeInRight delay-04s">
                    <div class="overview aa overview-box">
                        <img src="http://placehold.it/446x723" alt="popular-places" class="big-img">
                        <div class="mask">
                            <div class="info-2">
                                <div class="ds">
                                    <h2>Tokyo</h2>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 wow fadeInLeft delay-04s">
                <div class="row agent-4">
                    <div class="col-lg-5 col-md-12 col-pad">
                        <div class="photo">
                            <img src="http://placehold.it/224x250" alt="avatar-4" class="img-fluid">
                    ...
                    <div class="blog-2">
                        ...
                        <div class="detail">
                            ...
                            <div class="post-meta">
                                ...
                                <span><a href="#"><i class="fa fa-commenting-o"></i>27</a></span>
                ...
                <div class="slick-slide-item wow">
                    <div class="blog-2">
                        ...
                        <div class="detail">
                            ...
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the</p>
                            <a href="blog-single-sidebar-right.html" class="read-more" tabindex="0">Read more</a>
                        </div>
                    </div>
                </div>
                <div class="slick-slide-item">
            ...
            <div class="col-lg-4 col-md-12 col-sm-12">
                <div class="Subscribe-box">
                    <form class="form-inline" action="#" method="GET">
                        <input type="text" class="form-control mb-sm-0" id="inlineFormInputName4" placeholder="Email Address">
